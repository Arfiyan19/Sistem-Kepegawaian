                ...
                <div class="col-md-6">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <select class=" select" data-placeholder="Pilih salah satu" searchable="Search here.." name="agama">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="number" name="jml_anak" class="form-control" placeholder="Jumlah Anak . . ." value="{{ old('jml_anak') }}">
                            ...
                            <div class="row-md-6">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_ktp" class="form-control" rows="5" placeholder="Alamat sesuai KTP ..">{{ old('alamat_ktp') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="alamat_dom" class="form-control" rows="5" placeholder="Alamat sesuai Domisili Sekarang">{{ old('alamat_dom') }}</textarea>
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="email" class="form-control" value="{{ old('email') }}" placeholder="Email Pegawai . . .">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" name="password" class="form-control" value="" placeholder="Password Pegawai . . .">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select" data-live-search="true" data-placeholder="Pilih Role" searchable="Search here.." name="id_role">
                                ...
                                <option {{ old('id_role') == $key ? 'selected' : '' }} value="{{ $key }}">
                                    {{ $value }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <fieldset>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select" data-placeholder="Pilih Jabatan" name="id_jabatan">
                                        ...
                                        <option {{ old('id_jabatan') == $key ? 'selected' : '' }} value="{{ $key }}">
                                            {{ $value }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder="Pilih Divisi" class="select" name="id_divisi">
                                        ...
                                        <option {{ old('id_divisi') == $key ? 'selected' : '' }} value="{{ $key }}">
                                            {{ $value }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select" data-placeholder="Pilih Atasan (Kosongi Bila Tidak Ada)" name="id_atasan">
                                ...
                                <option {{ old('id_atasan') == $key ? 'selected' : '' }} value="{{ $key }}">
                                    {{ $key . ' - ' . $value }}
                                </option>
                                @endforeach
                            </select>
